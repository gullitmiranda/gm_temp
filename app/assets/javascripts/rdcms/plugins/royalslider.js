...
(function(l) {
  function t(b, f) {
    ...
    a.msEnabled ? (a.msTouch = Boolean(1 < window.navigator.msMaxTouchPoints), a.hasTouch = !1, a._n1 = 0.2, a._j1 = "MSPointerDown" + g, a._k1 = "MSPointerMove" + g, a._l1 = "MSPointerUp" + g, a._m1 = "MSPointerCancel" + g) : (a._j1 = "mousedown" + g, a._k1 = "mousemove" + g, a._l1 = "mouseup" + g, a._m1 = "mouseup" + g, "ontouchstart" in window || "createTouch" in document ? (a.hasTouch = !0, a._j1 += " touchstart" + g, a._k1 += " touchmove" + g, a._l1 += " touchend" + g, a._m1 += " touchcancel" + g, a._n1 = 0.5, a.st.sliderTouch && (a._f1 = !0)) : (a.hasTouch = !1, a._n1 = 0.2));
  ...
  t.prototype = {
    ...
    _s: function(b, f) {
      ...
      })) : b.is("img") && (b.addClass("rsImg rsMainSlideImage"), c(b, "src"))), d = b.find(".rsCaption"), d.length && (e.caption = d.remove()), e.content = b, h.ev.trigger("rsAfterParseNode", [b, e]), f && h.slides.push(e), 0 === e.images.length && (e.isLoaded = !0, e.isRendered = !1, e.isLoading = !1, e.images = null), e
    },
    _b2: function() {
      var b = this,
        f, c, h = function(a) {
    ...
    _k3: function(b, f) {
      if (this._l3) {
        ...
        this._b3 = b.pageX;
        this._c3 = b.pageY;
        "x" === d && 0 !== h ? this._f3 = 0 < h ? 1 : -1 : "y" === d && 0 !== a && (this._g3 = 0 < a ? 1 : -1);
    ...
    removeSlide: function(b) {
      var f = this.slides[b];
      f && (f.holder && f.holder.remove(), b < this.currSlideId && this.currSlideId--, this.slides.splice(b, 1), this.slidesJQ.splice(b, 1), this.ev.trigger("rsOnRemoveSlide", [b]), this._g4(b), b === this.currSlideId && this.ev.trigger("rsAfterSlideChange"))
    },
    _g4: function() {
      var b = this,
        f = b.numSlides,
    ...
    _v4: function(l) {
      ...
      l.each(function(l) {
        ...
        if (g = b.attr("data-fade-effect")) {
          if ("none" === g.toLowerCase() || "false" === g.toLowerCase()) g = !1
  ...
  b.extend(b.rsProto, {
    ...
    _a5: function() {
      ...
      a.ev.on("rsBeforeMove", function(b, e, c) {
        a._b5 && (c && a.st.autoPlay.stopAtAction ? a.stopAutoPlay() : (a._d5 = !0, a._e5()))
      });
      a._f5 = !1;
  ...
  c.extend(c.rsProto, {
    _j5: function() {
      ...
      "bullets" === a.st.controlNavigation && (a.ev.one("rsAfterPropsSetup", function() {
        ...
        d >= a.numSlides ? a._l5.append('<div class="rsNavItem rsBullet"><span></span></div>') : a._m5.eq(d).before('<div class="rsNavItem rsBullet"><span></span></div>');
  ...
  c.extend(c.rsProto, {
    ...
    _t5: function() {
      ...
      if (a.st.fullscreen.nativeFS) {
        ...
        if (!a.isAndroid) if ("undefined" != typeof document.cancelFullScreen) a._v5.supportsFullScreen = !0;
        else for (var d = 0; d < b.length; d++) if (a._v5.prefix = b[d], "undefined" != typeof document[a._v5.prefix + "CancelFullScreen"]) {
    ...
    enterFullscreen: function(a) {
      var b = this;
      if (b._v5) if (a) b._v5.requestFullScreen(c("html")[0]);
      else {
    ...
    exitFullscreen: function(a) {
      ...
      if (!b._x5) {
        ...
        var d;
        for (d = 0; d < b.numSlides; d++) a = b.slides[d], a.isRendered = !1, a.bigImage && (a.isBig = !1, a.slideId = -99, a.isBigLoaded = a.isLoaded, a.isBigLoading = a.isLoading, a.bigImage = a.image, a.bigIW = a.iW, a.bigIH = a.iH, a.isLoaded = a.isMedLoaded, a.isLoading = !1, a.image = a.medImage, a.images[0] = a.medImage, a.iW = a.medIW, a.iH = a.medIH, a.isAppended = a.contentAdded = !1, b._d6(a, !0), a.bigImage !== a.medImage && (a.sizeType = "med"));
        b.isFullscreen = !1;
        a = c(window);
        a.scrollTop(b._y5);
        a.scrollLeft(b._z5);
  ...
  f.extend(f.rsProto, {
    _i6: function() {
      ...
      "thumbnails" === a.st.controlNavigation && (a._j6 = {
        ...
        paddingTop: 0,
        paddingBottom: 0
      }, a.st.thumbs = f.extend({}, a._j6, a.st.thumbs), a._k6 = !0, !1 === a.st.thumbs.firstMargin ? a.st.thumbs.firstMargin = 0 : !0 === a.st.thumbs.firstMargin && (a.st.thumbs.firstMargin = a.st.thumbs.spacing), a.ev.on("rsBeforeParseNode", function(a, c, b) {
        c = f(c);
        ...
        e !== a._o5 && (a._o5 && (a._o5.removeClass("rsNavSelected"), a._o5 = null), a._m6 && a._n6(a.currSlideId), a._o5 = e.addClass("rsNavSelected"))
    ...
    updateThumbsSize: function() {
      var a = this,
        e = a._m5.first(),
        c = {}, b = a._m5.length;
      a._u6 = (a._e3 ? e.outerWidth() : e.outerHeight()) + a._w6;
      a._y3 = b * a._u6 - a._w6;
      ...
      else if (a.st.thumbs.navigation && !a._m6 && (a._m6 = !0, !a.hasTouch && a.st.thumbs.drag || a.hasTouch && a.st.thumbs.touch)) a._n5 = !0, a._l5.on(a._j1, function(b) {
        a._g2(b, !0)
      });
