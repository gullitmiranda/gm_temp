...
class ArticlesController < ApplicationController
  ...
  if Setting.for_key("rdcms.article.cache_articles") == "true"
  ...
  def load_associated_model_into_liquid
    Article::LiquidParser["#{@article.article_type_form_file.downcase}"] = @article_type
  end
  ...
  def get_articles_by_article_type
    @list_of_articles = Article.active.articletype("#{@article.article_type_form_file} Show")
  end
