  ...
  content do
    panel "Ueber Rdcms" do
      ...
      h3 "Installation von Rdcms"
        ...
        para "Im Gemfile: gem 'rdcms', :git => 'git://github.com/ikusei/Rdcms.git'"
        ...
        h4 "Einstellungen bei der Installation:"
          ...
          para "rdcms.menues.recreate_cache: dieselbe Einstellung wie bei den Widgets nur fuer die Menues."
